...
def transcribe_audio(stt, file_path, args, word_queue, stop_flag):
        ...
        print("Transcription: \n") if args.task == 'transcribe' else print("Translation: \n")
...
def main():
    parser = argparse.ArgumentParser(description="A command-line tool for EdgeWhisper.",formatter_class=argparse.ArgumentDefaultsHelpFormatter)
